...
async def help_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    help_text = (
        ...
        "5. *Оцените качество результата* с помощью кнопок:\n"
        "   • ✅ *Правильно* - если товар найден верно\n"
        "   • ❌ *Неправильно* - если результат не подходит\n"
        "   • ➕ *Добавить товар* - если товара нет в базе\n\n"
        
        "*ЗАЧЕМ ОЦЕНИВАТЬ РЕЗУЛЬТАТЫ?*\n"
        "Ваши оценки помогают боту становиться умнее! Каждый раз, когда вы отмечаете результат как правильный или неправильный, система обучается и улучшает качество поиска для всех пользователей.\n\n"
        ...
        "• *Обязательно оценивайте результаты* - это помогает улучшить систему!\n\n"
        ...
        "💡 Мы всегда готовы помочь и улучшить работу бота! Спасибо за помощь в обучении системы!"
    )
